...
<div class="row">
    <div class="col-md-6">
        <div class="content-box-header">
            <div class="panel-title">Formulario:Editar Guia</div>
                    ...
                    <fieldset>
                        <legend>Editar Guia</legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="fullnombre" value="<?php echo $_REQUEST['fullnombre']; ?>" type="text" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="text-field">genero</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="genero" value="<?php echo $_REQUEST['genero'] ?>" type="text" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="idiomas" value="<?php echo $_REQUEST['idiomas'] ?>" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="text-field">Descripcion</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="descripcion" value="<?php echo $_REQUEST['descripcion'] ?>" type="text">
                                </div>
                            </div>
                    </fieldset>
